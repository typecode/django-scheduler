...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'schedule_event_related_events')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_event', models.ForeignKey(orm['schedule.event'], null=False)),
            ('to_event', models.ForeignKey(orm['schedule.event'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'schedule_event_related_events'))
    ...
    models = {
        ...
        'schedule.event': {
            ...
            'admission_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'calendar': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schedule.Calendar']", 'null': 'True', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schedule.Category']"}),
            ...
            'locations': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['locations.Location']", 'symmetrical': 'False'}),
            'related_events': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_events_rel_+'", 'blank': 'True', 'to': "orm['schedule.Event']"}),
