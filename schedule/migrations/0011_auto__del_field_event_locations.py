...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'schedule_event_locations')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'schedule_event', 'locations',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['locations.Location']),
                      keep_default=False)

        # Removing M2M table for field locations on 'Event'
        db.delete_table(db.shorten_name(u'schedule_event_locations'))
