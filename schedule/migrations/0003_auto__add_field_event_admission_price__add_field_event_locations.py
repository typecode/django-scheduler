...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.admission_price'
        db.add_column(u'schedule_event', 'admission_price',
    ...
    def backwards(self, orm):
        # Deleting field 'Event.admission_price'
        db.delete_column(u'schedule_event', 'admission_price')
