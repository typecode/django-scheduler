...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'schedule_category', (
        ...
        db.add_column(u'schedule_event', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'schedule_category')

        # Deleting field 'Event.category'
        db.delete_column(u'schedule_event', 'category_id')
